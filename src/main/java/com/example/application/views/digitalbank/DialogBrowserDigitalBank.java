...
public class DialogBrowserDigitalBank extends Dialog {
    ...
    private BrowserOpener browser;


    public DialogBrowserDigitalBank(){
        setDraggable(true);
        setModal(false);
        setResizable(true);
        ...
        content = new VerticalLayout(layoutBrowser());
    ...
    private VerticalLayout layoutBrowser(){
        VerticalLayout layout = new VerticalLayout();
        String url = "https://web.bankingly.com/Administration.WebUI/Pages/General/Login.aspx?ID=LaPromotora";
        browser = new BrowserOpener();
        browser.setContent(new Button("click this button to open"));
        browser.setUrl(url);
