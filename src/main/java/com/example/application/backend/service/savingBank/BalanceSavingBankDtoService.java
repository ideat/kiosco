package com.example.application.backend.service.savingBank;

import com.example.application.backend.entity.savingBank.DetailTransactionSanvingBank;
import com.example.application.backend.entity.savingBank.HeaderBalanceSavingBank;
import com.example.application.backend.entity.savingBank.dto.BalanceSavingBankDto;
import com.example.application.backend.entity.savingBank.dto.DetailTransactionSavingBankDto;
import com.example.application.backend.repository.savingBank.DetailTransactionSavingBankMapper;
import com.example.application.backend.repository.savingBank.HeaderBalanceSavingBankMapper;
...
public class BalanceSavingBankDtoService {
    ...
    public BalanceSavingBankDto getBalanceSavingBank(String account,
        ...
        firstRegister.setDebit(initDebit);
        firstRegister.setCredit(initCredit*-1);
